        ...
        <div className="pt-6 px-4">
            ...
            <div className="flex bg-stone-900/50 p-1 rounded-xl mb-6 border border-white/5">
                <button
                    ...
                    className={`flex-1 py-2 text-xs font-bold uppercase tracking-widest rounded-lg transition-all ${mode === 'manual' ? 'bg-primary text-stone-900 shadow-lg' : 'text-stone-500 hover:text-stone-300'}`}
                >
                    Manual
                </button>
                <button
                    onClick={() => setMode('csv')}
                    className={`flex-1 py-2 text-xs font-bold uppercase tracking-widest rounded-lg transition-all ${mode === 'csv' ? 'bg-primary text-stone-900 shadow-lg' : 'text-stone-500 hover:text-stone-300'}`}
                >
                    Importar CSV
                </button>
            </div>
