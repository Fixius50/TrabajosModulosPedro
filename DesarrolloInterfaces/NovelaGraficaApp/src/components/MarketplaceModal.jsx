        ...
        try {
            ...
            if (items.length > 0) {
                ...
                setShopItems([
                    ...
                    { id: 'theme-comic', name: 'Tema Cómic', description: '¡POW! Estilo viñeta vibrante.', type: 'theme', cost: 500, asset_value: 'comic' },
                    { id: 'theme-manga', name: 'Tema Manga', description: 'Blanco y negro dramático.', type: 'theme', cost: 500, asset_value: 'manga' },
